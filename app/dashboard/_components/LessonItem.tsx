    ...
    return (
        <Link href={`/dashboard/${slug}/${lesson.id}`} className={buttonVariants({
            ...
            className: cn(
                ...
                completed && 'bg-green-100 dark:bg-green-900/30 border-green-300 dark:border-green-700 hover:bg-green-200 dark:hover:bg-green-green-900/50 text-green-800 dark:text-green-200', 
            ...
            <div className="flex items-center gap-2.5 w-full min-w-0">
                <div className="shrink-0">
                    {completed ? (
                        ...
                        <Play className={cn(
                            "size-2.5 fill-current", isActive ? 'text-primary dark:text-primary-foreground' : 'text-muted-foreground'
                        )} />
                    </div>
                    )}
                </div>
                ...
                <div className="flex-1 text-left min-w-0">
                    <p className={cn(
                        "text-xs font-medium truncate", completed ? 'text-green-800 dark:text-green-200' : isActive ? 'text-primary font-semibold' : 'text-foreground'
